...
int main (int argc, char **argv) {
    /*
     * Promenljive `yyin` i `yyout` su definisane u lex.yy.c datoteci
     * i predstavljaju ulaz odnosno izlaz, sa koga funkcija yylex cita 
     * odnosno pise. 
     * Podrazumevane vrednosti ovih promenljivih su standardni ulaz tj.
     * standardni izlaz.
     */
